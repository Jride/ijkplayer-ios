...
//    [[UIApplication sharedApplication] setStatusBarOrientation:UIInterfaceOrientationLandscapeLeft animated:NO];
    ...
    NSURL *newurl = [NSURL URLWithString:@"rtsp://admin:Passw0rdsc101@thegentry101.thddns.net:6774/LiveChannel/3/media.smp"];
  
//  NSURL *newurl = [NSURL URLWithString:@"rtsp://184.72.239.149/vod/mp4:BigBuckBunny_175k.mov"];
  
  
    self.player = [[IJKFFMoviePlayerController alloc] initWithContentURL:newurl withOptions:options];
